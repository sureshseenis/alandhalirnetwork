...
<head>
    <title><? echo lang('create_new_account'); ?> | Alandhalir</title>
    <meta charset="UTF-8">
    ...
    <div align="center">
        ...
        <!--============[ sign up sec ]============-->
            ...
            <p><input type="text" name="signup_fullname" class="login_signup_textfield" id="fn" placeholder="Full Name"/></p>
            <p><input type="text" name="signup_username" class="login_signup_textfield" id="un" placeholder="Username"</p>
            <p><input type="email" name="signup_email" class="login_signup_textfield" id="em" placeholder="Email"/></p>
            <p><input type="password" name="signup_password" class="login_signup_textfield" id="pd" placeholder="Password"/></p>
            <p><input type="password" name="signup_cpassword" class="login_signup_textfield" id="cpd" placeholder="Conform Password"/></p>
            <p> 
            ...
            <p style="font-size: 11px;color: #5d5d5d;margin: 8px 0px; ">
                <? echo lang('by_clicking_signup_str'); ?> <a href="terms"><? echo lang('terms'); ?></a>, <a href="privacy">Privacy Policy</a> <? echo lang('and'); ?> <a href="cookie"><? echo lang('cookie_use'); ?></a>.</p>
            <button type="submit" class="login_signup_btn2" id="signupFunCode">Create Account</button>
        ...
        <div style="background: #fff; border-radius: 3px; width: 420px; padding: 15px; margin: 15px;color: #7b7b7b;" align="center">
            Already Have account?<a href="login">Login</a>.<hr style="margin: 8px;">
